...
nmds.plot = plot_ordination(antibiotic.even.ps, antibiotic.even.nmds, type="samples")
antibiotic.even.nmds.data = nmds.plot$data
antibiotic.even.nmds$stress
```
...
```{r}
ggplot(antibiotic.even.nmds.data, aes(NMDS1, NMDS2)) +
  theme_classic() +
  geom_point(data = transform(antibiotic.even.nmds.data, aspiration_bool = NULL, lung = NULL), 
             color = "grey90") +
