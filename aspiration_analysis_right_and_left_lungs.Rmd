...
```{r, echo=FALSE, results='hide'}
right_left1_ASWLU_ASWRU.nmds.plot = NMDSPlot(right_left1_ASWLU_ASWRU.even.ps, grouping = "lung")
...
```{r, echo=FALSE}
right_left1_ASWLU_ASWRU.perm = RunPermanova(right_left1_ASWLU_ASWRU.even.ps, "lung")
