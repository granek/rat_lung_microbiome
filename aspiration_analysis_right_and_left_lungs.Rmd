...
> CHECK Lefse, then set to "eval=FALSE"
...
```{r right_left3_WLU_WRU_group2_process_lefse, echo=FALSE}
# list.files(paste0(file_path_sans_ext(right_left3_WLU_WRU_group2_lefse.file), ".res"))
# list.files(basename(right_left3_WLU_WRU_group2_lefse.file))
# 
# list.files(dirname(right_left3_WLU_WRU_group2_lefse.file))
# list.files(right_left3_WLU_WRU_group2_lefse.file)
# read.delim(right_left3_WLU_WRU_group2_lefse.file) %>% head
# 
res.df = paste0(file_path_sans_ext(right_left3_WLU_WRU_group2_lefse.file), ".res") %>%
...
> Check that cohort subclass is working
...
> Check that lefse doesn't find anything
...
> check that lefse has no results
